...
RUN apt update && apt install --yes --force-yes swig libjpeg-dev zlib1g-dev python3-dev python3-numpy wget git python3-pip bazel && pip3 install numpy pybind11 && wget https://github.com/bazelbuild/bazel/releases/download/5.1.1/bazel-5.1.1-linux-x86_64 && mv bazel-5.1.1-linux-x86_64 /usr/bin/bazel-5.1.1
