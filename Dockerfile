...
RUN apt update && apt install --yes --force-yes swig libjpeg-dev zlib1g-dev python3-dev python3-numpy wget git python3-pip bazel-5.1.1 && pip3 install numpy pybind11
